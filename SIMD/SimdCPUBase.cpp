...
#error Do not know how to detect CPU info!
...
#if defined(__GNUC__) && (defined(CV_SIMD_PPC_ENABLE) || defined(CV_SIMD_PPC64_ENABLE) || defined(CV_SIMD_ARM_ENABLE) || defined(CV_SIMD_ARM64_ENABLE))
...
#endif//defined(__GNUC__) && (defined(CV_SIMD_PPC_ENABLE) || defined(CV_SIMD_PPC64_ENABLE) || defined(CV_SIMD_ARM_ENABLE) || defined(CV_SIMD_ARM64_ENABLE))
        ...
        CV_INLINE size_t CorrectIfZero(size_t value, size_t otherwise)
    {
